(() => {
  ...
  function wireEvents(){
    refs.back.onclick=goBack;refs.cameraBack.onclick=goBack;refs.cameraSettings.onclick=openCameraSettingsModal;refs.settings.onclick=()=>state.view==='camera'?openCameraSettingsModal():setView('settings');refs.captureContextBtn.onclick=openCaptureContextModal;refs.editCaptureContext.onclick=openCaptureContextModal;
